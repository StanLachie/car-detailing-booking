  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "relative flex-1 min-w-0 p-0 text-center [&:last-child[data-selected=true]_button]:rounded-r-md group/day select-none",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      data-day={day.date.toLocaleDateString("en-AU", { timeZone: "Australia/Brisbane" })}
